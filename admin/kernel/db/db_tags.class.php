...
*/
	...
	public function add($args) {
		...
		$this->xml->list->addGodChild('tag', array('id' => $id, 'name' => $args['name'], 'name_human' => $args['name_human']));
	...
	public function link($args) {
		$node = $this->xml->xpath('/tags/links/link[@id_tag="'
				. utf8_encode($args['id_tag'])
				. '" and @id_post="'
				. utf8_encode($args['id_post'])
				. '"]');
		...
		// Add the table
		$this->xml->links->addGodChild('link', array('id_tag' => $args['id_tag'], 'id_post' => $args['id_post']));
