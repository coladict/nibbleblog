...
class Social {
	...
	public static function twitter_share($args = array()) {
		// HTML Code
		$code = '<a href="https://twitter.com/share" class="twitter-share-button" data-url="'
				. $args['url']
				. '" data-text="'
				. $args['text'].'">Tweet</a>'
	...
	public static function facebook_like($args = array()) {
		// HTML Code
		$code = '<iframe src="https://www.facebook.com/plugins/like.php?href='
				. $args['url']
				. '&amp;layout=button_count" scrolling="no" frameborder="0" '
